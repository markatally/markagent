...
|-----------|----------|---------|
| Test scripts | `tests/` | All test scripts and test suites must be placed under root `tests/` directory |
| Generated files | `outputs/` | All files generated by agent (PPT, code, artifacts) must be saved under root `outputs/` directory |

### Progress Tracking
- Update `PROGRESS.md` to record test status for each function/feature
- Include timestamp, accomplishments, next steps, and any blockers
- Document new features with their test results
...
├── integration/       # Integration tests for API routes
├── fixtures/          # Test fixtures and mock data
├── ppt_generator.test.ts
└── test-ppt-generation.ts  # Integration test scripts

outputs/
├── ppt/               # Generated PowerPoint files
...
4. Save generated files to `outputs/` directory (project convention)
5. Create unit tests in `tests/unit/`
6. Update `PROGRESS.md` with test status

Example: `ppt_generator.ts` creates `.pptx` files in `outputs/ppt/`
...
- `.claude/SKILL.md` - Claude Code development guidance
...
| Skill | Purpose | Status | Tool |
|--------|---------|--------|-------|
| /code | Code generation and development | ✅ Implemented | code_analyzer |
| /refactor | Code refactoring | ✅ Implemented | code_analyzer |
| /review | Code review | ✅ Implemented | code_analyzer |
| /api | API development | ✅ Implemented | - |
| /prompt | Prompt engineering | ✅ Implemented | - |
| /tool | Tool development | ✅ Implemented | - |
| /auth | Authentication | ✅ Implemented | - |
| /component | Component creation | ✅ Implemented | - |
| /debug | Debug code | ✅ Implemented | code_analyzer |
| /fix | Fix code issues | ✅ Implemented | code_analyzer |
| /test | Test generation | ✅ Implemented | test_runner |
| /coverage | Code coverage | ✅ Implemented | test_runner |
| /deploy | Deployment | ✅ Implemented | - |
| /docker | Docker operations | ✅ Implemented | - |
| /git | Git operations | ✅ Implemented | git_operations |
| /migrate | Migrations | ✅ Implemented | - |
| /ci | CI/CD | ✅ Implemented | - |
| /env | Environment | ✅ Implemented | - |
| /monitor | Monitoring | ✅ Implemented | - |
| /docs | Documentation | ✅ Implemented | - |
| /api-docs | API documentation | ✅ Implemented | - |
| /changelog | Changelog | ✅ Implemented | - |
| /analyze | Code analysis | ✅ Implemented | code_analyzer |
| /security | Security audit | ✅ Implemented | code_analyzer |
| /scrape | Web scraping | ✅ Implemented | web_scraper |
| /web_search | Academic web search | ✅ Implemented | web_search |
| /data | Data operations | ✅ Implemented | - |
| /sql | SQL operations | ✅ Implemented | - |
| /mcp | MCP integration | ✅ Implemented | mcp |
| /plan | Planning | ✅ Implemented | - |
| /architect | Architecture | ✅ Implemented | - |

**Built-in Tools (Backend):**
- file_reader - Read files from workspace
- file_writer - Write files to workspace
- bash_executor - Execute shell commands
- ppt_generator - Generate PowerPoint presentations
- web_search - Search arXiv, alphaXiv, Google Scholar
